...
const CountDownModal = (props) => {
	return (
		<div
			className='flex justify-center w-screen h-screen items-center antialiased absolute top-0 left-0 overflow-hidden'
			style={{ backgroundColor: 'rgb(0 0 0 / 70%)' }}
		>
			<div
				className='flex flex-col mx-auto rounded-lg bg-gray-50 border border-gray-300 shadow-xl'
				style={{ width: 300 }}
			>
				<div className='flex flex-row justify-between p-6 bg-white border-b border-gray-200 rounded-tl-lg rounded-tr-lg'>
					...
					<h3
						...
						onClick={() => props.setModalVisible('hidden')}
					>
						<FaTimes />
					</h3>
				</div>
