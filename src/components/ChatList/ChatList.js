...
const ChatList = () => {
	...
	return (
		<div
			className='overflow-y-auto relative overflow-x-hidden scrollbar-fit rounded mb-4'
			style={{}}
		>
			{chats?.length ? (
				<ul className='px-2'>
			...
			<h3
				className='text-white fixed bottom-4 text-xl p-4 rounded-full bg-blue-500 cursor-pointer shadow-md'
				style={{ left: 364 }}
			>
				<FaPlus />
			</h3>
